/**
 * seed-data 云函数 —— 初始化脱敏样例数据
 *
 * 【业务说明】
 * 快速创建两家门店、与其对应服务项目、以及样例用户账号，
 * 便于开发、测试与本科毕业设计验收环境快速建立初始数据。
 *
 * 【幂等性设计】
 ...
 */
// 初始化脱敏样例数据：门店/服务/账号样例
const { withResponse, requireRole } = require('sb-common');

// SHA-256("123456") 的哈希值，用于创建样例账号时设置初始密码
...
exports.main = withResponse(async (event, context) => {
  ...
  // 创建样例账号集：普通用户 ×1、理发师 ×2（分属 storeA/storeB）、管理员 ×2（分属 storeA/storeB）。初始密码均为 123456
